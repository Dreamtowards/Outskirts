...
public class PerlinNoise {
    ...
    public static int[] perm = { // length: 257, range: 0-255, "151" duplicated
    ...
    public static float noise(float x) {
        int X = Maths.floor(x) & 0xFF; // clamp(floor(x), 0, 255)
        x -= Maths.floor(x);           // 0.0-1.0
        float u = fade(x);             // smoothed x 0.0-1.0
