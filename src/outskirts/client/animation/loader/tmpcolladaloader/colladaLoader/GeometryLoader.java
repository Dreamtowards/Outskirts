package outskirts.client.animation.loader.tmpcolladaloader.colladaLoader;

import outskirts.client.animation.loader.tmpcolladaloader.dataStructures.MeshData;
import outskirts.client.animation.loader.tmpcolladaloader.dataStructures.Vertex;
import outskirts.client.animation.loader.tmpcolladaloader.dataStructures.VertexSkinData;
import outskirts.client.animation.loader.tmpcolladaloader.xmlParser.XmlNode;
...
import static outskirts.client.animation.loader.tmpcolladaloader.colladaLoader.AnimationLoader.CORRECTION;
...
public class GeometryLoader {
	...
	private void readPositions() {
		...
		for (int i = 0; i < count/3; i++) {
			...
			Matrix4f.transform(CORRECTION, position);
	...
	private void readNormals() {
		...
		for (int i = 0; i < count/3; i++) {
			...
			Matrix4f.transform(CORRECTION, norm);
