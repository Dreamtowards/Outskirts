...
public class Terrain implements Savable {
    ...
    public static final int VERT_SIZE = 32; // heights fields density
    public static final int SIZE = 16;    // world coordinates

    public final int x;
    public final int z;

    public float[][] heights = new float[VERT_SIZE][VERT_SIZE];
    ...
    public float getHeight(float x, float z) {
        return heights[(int)(Maths.mod(x, SIZE)/SIZE * VERT_SIZE)]
                      [(int)(Maths.mod(z, SIZE)/SIZE * VERT_SIZE)];
    }
